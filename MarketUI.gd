...
@export var player_list_path: NodePath
@export var player_money_label_path: NodePath
@export var hub_list_path: NodePath
@export var hub_money_label_path: NodePath
@onready var player_list: ItemList        = get_node(player_list_path)
@onready var player_money_label: Label    = get_node(player_money_label_path)
